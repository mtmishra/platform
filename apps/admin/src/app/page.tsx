import { Heading, Paragraph, MetricCardV2, RevenueChart, FunnelChart, TrustBar, StaggerContainer, StatusBadge } from "@leapmoney/ui";
              ...
              <li key={n.id} className="flex flex-col gap-0.5 px-5 py-4">
                <span className="flex items-center justify-between gap-2">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span className="text-body-md font-semibold text-foreground-primary">{n.title}</span>
                  </span>
