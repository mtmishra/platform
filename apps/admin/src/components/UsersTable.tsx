  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="overflow-hidden rounded-lg border border-border-token-default bg-background-card shadow-1">
        ...
        <StaggerContainer className="flex flex-col divide-y divide-border-token-default">
          {filtered.map((u) => (
            <div key={u.id} className="grid grid-cols-[1fr_auto] items-center gap-3 px-4 py-3 sm:grid-cols-[1.4fr_0.8fr_1.2fr_0.8fr]">
